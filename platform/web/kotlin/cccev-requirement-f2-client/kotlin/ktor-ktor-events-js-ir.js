(function (root, factory) {
  ...
  var LinkedListNode = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.r1;
  ...
  function Events() {
    this.x3s_1 = new CopyOnWriteHashMap();
  }
  Events.prototype.y3s = function (definition, value) {
    var exception = null;
    var tmp0_safe_receiver = this.x3s_1.y1(definition);
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlinx.coroutines.internal.LinkedListHead.forEach' call
      var cur = tmp0_safe_receiver.y1e_1;
      while (!equals(cur, tmp0_safe_receiver)) {
        if (cur instanceof HandlerRegistration) {
          // Inline function 'io.ktor.events.Events.raise.<anonymous>' call
          var tmp0__anonymous__q1qw7t = cur;
          try {
            var tmp = tmp0__anonymous__q1qw7t.c3t_1;
