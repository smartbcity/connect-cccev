(function (root, factory) {
  ...
  function $serializer() {
    ...
    tmp0_serialDesc.pr('duration', true);
    tmp0_serialDesc.pr('endTime', true);
    tmp0_serialDesc.pr('startTime', true);
  ...
  $serializer.prototype.nh = function (decoder) {
    ...
    if (tmp7_input.il()) {
      tmp4_local0 = tmp7_input.hl(tmp0_desc, 0, StringSerializer_getInstance(), tmp4_local0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
      tmp5_local1 = tmp7_input.hl(tmp0_desc, 1, IntSerializer_getInstance(), tmp5_local1);
      tmp3_bitMask0 = tmp3_bitMask0 | 2;
      tmp6_local2 = tmp7_input.hl(tmp0_desc, 2, IntSerializer_getInstance(), tmp6_local2);
  ...
  $serializer.prototype.y2i = function (encoder, value) {
    var tmp0_desc = this.x2i_1;
    var tmp1_output = encoder.tk(tmp0_desc);
    if (tmp1_output.om(tmp0_desc, 0) ? true : !(value.duration == null)) {
      tmp1_output.km(tmp0_desc, 0, StringSerializer_getInstance(), value.duration);
    }
    if (tmp1_output.om(tmp0_desc, 1) ? true : !(value.endTime == null)) {
      tmp1_output.km(tmp0_desc, 1, IntSerializer_getInstance(), value.endTime);
    }
    if (tmp1_output.om(tmp0_desc, 2) ? true : !(value.startTime == null)) {
      tmp1_output.km(tmp0_desc, 2, IntSerializer_getInstance(), value.startTime);
    }
    tmp1_output.uk(tmp0_desc);
  };
  $serializer.prototype.mh = function (encoder, value) {
    return this.y2i(encoder, value instanceof PeriodOfTime ? value : THROW_CCE());
  };
  ...
  function PeriodOfTime_init_$Init$_0(seen1, duration, endTime, startTime, serializationConstructorMarker, $this) {
    if (!(0 === (0 & seen1))) {
      throwMissingFieldException(seen1, 0, $serializer_getInstance().x2i_1);
    }
    if (0 === (seen1 & 1))
      $this.duration = null;
    else
  ...
  PeriodOfTime.prototype.z2i = function () {
    return this.duration;
  };
  PeriodOfTime.prototype.a2j = function () {
    return this.endTime;
  };
  PeriodOfTime.prototype.b2j = function () {
