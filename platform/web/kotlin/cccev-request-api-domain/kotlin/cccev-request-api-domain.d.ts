...
export namespace cccev.f2.evidence.api.domain.features.query {
    ...
    interface GetEvidenceTypeListsQueryResultDTO {
        ...
        readonly evidenceTypeListsOfEvidenceTypes: any/* kotlin.collections.Map<string, kotlin.collections.List<string>> */;
...
export namespace cccev.f2.request.api.domain.features.query {
...
export as namespace cccev_request_api_domain;