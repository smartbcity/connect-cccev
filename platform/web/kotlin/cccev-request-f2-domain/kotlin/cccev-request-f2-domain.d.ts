...
export namespace cccev.f2.request.domain.features.query {
    ...
    interface GetRequestScoreQueryResultDTO {
        ...
        readonly scorePerInformationConcept: kotlin.collections.Map<string, number>;

    }
}
export as namespace cccev_request_f2_domain;