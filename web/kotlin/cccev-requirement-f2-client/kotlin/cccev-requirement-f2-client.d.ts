...
export namespace cccev.s2.request.domain {
    interface RequestEvent extends s2.dsl.automate.S2Event<s2.dsl.automate.S2State/* cccev.s2.request.domain.RequestState */, string> {
        readonly id: string;
        readonly type: s2.dsl.automate.S2State/* cccev.s2.request.domain.RequestState */;
...
export namespace cccev.s2.request.domain.features.command {
    ...
    interface RequestAuditedEventDTO extends cccev.s2.request.domain.RequestEvent {
        readonly id: string;
        readonly type: s2.dsl.automate.S2State/* typeof cccev.s2.request.domain.RequestState.Audited */;
...
export namespace cccev.s2.request.domain.features.command {
    ...
    interface RequestEvidenceAddedEventDTO extends cccev.s2.request.domain.RequestEvent {
        readonly id: string;
        readonly type: s2.dsl.automate.S2State/* typeof cccev.s2.request.domain.RequestState.Created */;
...
export namespace cccev.s2.request.domain.features.command {
    ...
    interface RequestInitializedEventDTO extends f2.dsl.cqrs.Event {
        readonly id: string;
...
export namespace cccev.s2.request.domain.features.command {
    ...
    interface RequestSentEventDto extends cccev.s2.request.domain.RequestEvent {
        readonly id: string;
        readonly type: s2.dsl.automate.S2State/* typeof cccev.s2.request.domain.RequestState.Sent */;
...
export namespace cccev.s2.request.domain.features.command {
    ...
    interface RequestSignedEventDto extends cccev.s2.request.domain.RequestEvent {
        readonly id: string;
        readonly type: s2.dsl.automate.S2State/* typeof cccev.s2.request.domain.RequestState.Signed */;
...
export namespace cccev.s2.request.domain.model {
    interface RequestDTO {
        readonly id: string;
        status: s2.dsl.automate.S2State/* cccev.s2.request.domain.RequestState */;
        readonly frameworkId: string;
        readonly evidences: kotlin.collections.List<cccev.dsl.model.EvidenceDTO>;
        readonly supportedValues: kotlin.collections.Map<string, cccev.dsl.model.SupportedValueDTO>;
...
export namespace cccev.s2.evidence.domain {
    ...
    interface EvidenceTypeEvent extends f2.dsl.cqrs.Event, s2.dsl.automate.WithId<string> {
        readonly id: string;
...
export namespace cccev.s2.evidence.domain {
    ...
    interface EvidenceTypeListEvent extends f2.dsl.cqrs.Event, s2.dsl.automate.WithId<string> {
        readonly id: string;
...
export namespace cccev.s2.requirement.domain {
    ...
    interface RequirementEvent extends f2.dsl.cqrs.Event, s2.dsl.automate.WithId<string> {
        readonly id: string;
...
export namespace cccev.f2.requirement.domain.command {
    interface ConstraintCreateCommandDTO {
        ...
        readonly hasEvidenceTypeList: kotlin.collections.List<string>;
        readonly hasRequirement: kotlin.collections.List<string>;
        isRequirementOf: Nullable<any>/* Nullable<kotlin.collections.List<string>> */;
...
export namespace cccev.f2.requirement.domain.query {
    ...
    interface GetRequirementListQueryResultDTO {
        readonly requirements: kotlin.collections.List<cccev.dsl.model.Requirement>;
...
export as namespace cccev_requirement_f2_client;