...
export namespace cccev.dsl.dto.model {
    interface EvidenceTypeListDTO extends ccev.dsl.core.EvidenceTypeList {
        readonly specifiesEvidenceType: any/* kotlin.collections.List<cccev.dsl.dto.model.EvidenceTypeDTO> */;
        readonly description: string;
        readonly identifier: string;
        readonly name: string;
        readonly __doNotUseIt: __doNotImplementIt;
...
export namespace cccev.dsl.dto.query {
    ...
    interface GetEvidenceTypeListsQueryResultDTO {
        readonly evidenceTypeLists: any/* kotlin.collections.List<any/* kotlin.collections.List<cccev.dsl.dto.model.EvidenceTypeListDTO> */> */;
        readonly __doNotUseIt: __doNotImplementIt;
    }
}
export namespace cccev.dsl.dto.query {
    ...
    interface GetInformationConceptsQueryResultDTO {
        readonly informationConcepts: any/* kotlin.collections.List<cccev.dsl.dto.model.InformationConceptDTO> */;
        readonly __doNotUseIt: __doNotImplementIt;
    }
}
export namespace cccev.dsl.dto.query {
    ...
    interface GetRequestScoreQueryResultDTO {
        ...
        readonly scorePerInformationConcept: any/* kotlin.collections.Map<string, number> */;
        readonly __doNotUseIt: __doNotImplementIt;
    }
}
export namespace cccev.dsl.dto.query {
    ...
    interface GetRequirementQueryResultDTO {
        readonly requirement: any/* Nullable<ccev.dsl.core.Requirement> */;
        readonly __doNotUseIt: __doNotImplementIt;
    }
}
export as namespace cccev_cccev_dsl_dto;