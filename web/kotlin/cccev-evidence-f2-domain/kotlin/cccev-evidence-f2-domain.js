...
(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['@js-joda/core'] === 'undefined') {
      throw new Error("Error loading module 'cccev-evidence-f2-domain'. Its dependency '@js-joda/core' was not found. Please, check whether '@js-joda/core' is loaded prior to 'cccev-evidence-f2-domain'.");
    }
    root['cccev-evidence-f2-domain'] = factory(typeof this['cccev-evidence-f2-domain'] === 'undefined' ? {} : this['cccev-evidence-f2-domain'], this['@js-joda/core']);
  }
