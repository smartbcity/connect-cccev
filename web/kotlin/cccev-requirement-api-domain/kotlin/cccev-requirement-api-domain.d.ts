...
export namespace cccev.f2.requirement.api.domain.features.query {
    ...
    interface GetRequirementListQueryResultDTO {
        readonly requirements: any/* kotlin.collections.List<any/* cccev.core.dsl.Requirement */> */;
    }
}
export namespace cccev.f2.requirement.api.domain.features.query {
    ...
    interface GetRequirementQueryResultDTO {
        readonly requirement?: cccev.core.dsl.Requirement;
    }
}
export as namespace cccev_requirement_api_domain;