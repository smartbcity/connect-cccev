...
(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['@js-joda/core'] === 'undefined') {
      throw new Error("Error loading module 'cccev-evidence-type-domain'. Its dependency '@js-joda/core' was not found. Please, check whether '@js-joda/core' is loaded prior to 'cccev-evidence-type-domain'.");
    }
    root['cccev-evidence-type-domain'] = factory(typeof this['cccev-evidence-type-domain'] === 'undefined' ? {} : this['cccev-evidence-type-domain'], this['@js-joda/core']);
  }
